...
% --- Resumen -----------------------------------------------------------------
\begin{abstract}\noindent
La aplicación de modelos de Machine Learning supervisado en medicina predictiva
...
desarrolla un benchmarking comparativo para evaluar el impacto de dos
...
informativos y riesgo potencial de \textit{Data Leakage}. La primera estrategia
(V1) incorpora razonamiento clínico-estadístico mediante imputación
estratificada por diagnóstico, exclusión de variables derivadas o temporales y
tratamiento contextual de la ausencia de datos. La segunda estrategia (V2)
representa un enfoque técnico-estadístico basado en reglas automáticas,
umbrales de valores faltantes e imputación global por mediana o moda.
...
Forest, Gradient Boosting Machine, Support Vector Machine y K-Nearest Neighbors,
mediante una arquitectura reproducible en R/tidymodels. El dataset fue dividido
en entrenamiento, validación y prueba final, utilizando el conjunto de
validación para comparar modelos y configuraciones, y reservando el conjunto de
prueba para la evaluación final del mejor modelo seleccionado. Los resultados
muestran que los modelos de ensamble, especialmente Random Forest y GBM,
alcanzaron el mejor rendimiento global. Desde una perspectiva puramente
métrica, la estrategia técnico-estadística obtuvo los valores más altos de
AUC-ROC, cercanos a 0.978 en validación y 0.975 en prueba, frente a valores
alrededor de 0.949 en validación y 0.942 en prueba en la estrategia
clínico-estadística. Sin embargo, esta diferencia revela una tensión
metodológica central: el mayor rendimiento numérico puede estar influido por la
retención de variables con menor validez clínica o con riesgo de introducir
información no disponible en un escenario predictivo real. En conjunto, los
hallazgos indican que la hipótesis inicial se confirma de forma parcial: el
preprocesamiento informado por conocimiento clínico no maximiza necesariamente
el AUC bruto, pero sí contribuye a construir modelos más interpretables,
metodológicamente prudentes y coherentes con la lógica biomédica.
\medskip\noindent
\textbf{Palabras clave:} Machine Learning supervisado, medicina predictiva,
SUPPORT2, mortalidad hospitalaria, preprocesamiento clínico, benchmarking,
Data Leakage, R
\end{abstract}
