...
Forest, Gradient Boosting Machine, C5.0 y K-Nearest Neighbors, bajo escenarios
con y sin escalado, así como con validación cruzada y partición hold-out. Los
resultados muestran que los modelos de ensamble, especialmente Random Forest y
GBM, alcanzaron el mejor rendimiento global. Desde una perspectiva puramente
métrica, la estrategia técnico-estadística obtuvo los valores más altos de
AUC-ROC, cercanos a 0.972, frente a valores alrededor de 0.933 en la estrategia
