...
|-- preprocessing/
|-- models/
|-- scripts/modeling_utils_tidymodels.R
|-- requirements-r.txt
|-- figures/
`-- manuscript/
\end{lstlisting}
...
\begin{longtable}{>{\raggedright\arraybackslash}p{2.1cm}>{\raggedright\arraybackslash}p{1.8cm}>{\raggedright\arraybackslash}p{7.0cm}>{\raggedright\arraybackslash}p{3.2cm}}
