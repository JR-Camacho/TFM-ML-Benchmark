...
Dentro de los modelos supervisados más utilizados en tareas de clasificación binaria se encuentran la regresión logística, los árboles de decisión, Random Forest, las máquinas de vectores de soporte, K-Nearest Neighbors y Naive Bayes.
...
Random Forest corresponde a un método de ensamblaje basado en múltiples árboles de decisión, permitiendo mejorar estabilidad y capacidad predictiva respecto a modelos individuales. Las máquinas de vectores de soporte (SVM) buscan encontrar hiperplanos óptimos capaces de separar clases dentro del espacio de características, siendo útiles en problemas de alta dimensionalidad.
...
Estos modelos continúan siendo ampliamente utilizados dentro de investigaciones clínicas y benchmarking de aprendizaje automático debido a su capacidad de clasificación, facilidad de implementación y adaptabilidad a distintos tipos de conjuntos de datos médicos~\citep{james2021}.
