...
discriminación con valores de AUC de 0.933 en el escenario clínico-estadístico
y de hasta 0.972 en el escenario técnico-estadístico. Estos resultados indican
...
frente a aproximaciones lineales o basadas en distancia como KNN. La regresión
logística también mostró un rendimiento relevante, con un AUC de 0.918 en el
escenario biológico, lo que sugiere que parte de los predictores seleccionados
mantienen una relación discriminativa estable con la mortalidad hospitalaria.
Por el contrario, la inestabilidad del árbol de decisión simple (rpart) en los
escenarios sin validación cruzada subraya la necesidad de emplear metodologías
de remuestreo y evaluación probabilística para mejorar la estabilidad de las
predicciones en entornos biomédicos.
