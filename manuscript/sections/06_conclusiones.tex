...
hasta 0.920 en validación y 0.932 en evaluación externa en el escenario
clínico-estadístico, y de hasta 0.974 en validación cruzada y 0.979 en
evaluación externa en el escenario técnico-estadístico. Estos resultados indican
...
frente a aproximaciones basadas en distancia como KNN. La regresión logística
también mostró un rendimiento relevante, con AUC superiores a 0.91 en el
escenario biológico, lo que sugiere que parte de los
predictores seleccionados mantienen una relación discriminativa estable con la
mortalidad hospitalaria. La evaluación externa permitió contrastar la tendencia
observada durante la validación sin utilizar los conjuntos de evaluación como
